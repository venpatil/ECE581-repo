...
if [is_common_ui_mode ] {
    echo create_timing_condition -library_sets libs_max -name timingcondition_max  >> mmmc.tcl
    echo create_timing_condition -library_sets libs_min -name timingcondition_min  >> mmmc.tcl
    echo create_delay_corner -name max_corner -timing_condition timingcondition_max -rc_corner cmax >> mmmc.tcl
    echo create_delay_corner -name min_corner -timing_condition timingcondition_min -rc_corner cmin >> mmmc.tcl
} else {
